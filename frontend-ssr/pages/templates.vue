                ...
                >
                    ...
                    <div class="aspect-[3/4] relative p-4 cursor-pointer bg-gradient-to-br from-slate-50 to-slate-100" @click="openModal(template)">
                        ...
                        <div class="template-overlay absolute inset-0 flex flex-col items-center justify-center gap-3">
                            ...
                            <NuxtLink to="/builder" class="template-action px-6 py-2.5 bg-indigo-600 text-white rounded-lg font-bold shadow-lg hover:bg-indigo-500 transition-colors w-40 text-center" style="transition-delay: 0.15s">
                                Use Template
                            </NuxtLink>
                        </div>
                    </div>
        ...
        <section class="py-24 bg-gradient-to-br from-slate-900 to-indigo-900 text-white text-center px-6 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <NuxtLink to="/builder" class="px-8 py-4 bg-transparent border border-indigo-400 text-white font-bold rounded-xl hover:bg-indigo-800 transition-colors">
            ...
            <div class="absolute inset-0 flex items-center justify-center p-4">
                <div class="bg-white w-full max-w-4xl h-[90vh] rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden relative transform transition-all">
                    ...
                    <div class="w-full md:w-1/3 bg-slate-50 border-r border-slate-200 p-8 flex flex-col overflow-y-auto">
                        ...
                        <div class="mt-auto">
                            <NuxtLink to="/builder" class="block w-full py-3 bg-indigo-600 text-white font-bold rounded-xl text-center shadow-lg hover:bg-indigo-500 hover:shadow-indigo-500/25 transition-all">
                                Use This Template
                            </NuxtLink>
                        </div>
                    </div>

  ...
  <div class="flex-grow">
    ...
    <section v-if="showResults" class="container mx-auto px-6 py-12 pb-24">
      ...
      <div class="mt-8 flex justify-center animate-slide-up" style="animation-delay: 0.9s;">
        <NuxtLink to="/builder" class="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-indigo-600 border border-transparent rounded-full shadow-lg hover:bg-indigo-700 hover:shadow-indigo-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 transform hover:-translate-y-1">

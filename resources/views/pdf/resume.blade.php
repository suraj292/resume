        ...
        <div class="page">
            <div class="two-column">
                ...
                <div class="left-column">
                    ...
                    @else
                        <!-- Page 2+ Header -->
                        <div class="page-header">{{ $data['personal']['name'] ?? 'Resume' }}</div>
                ...
                <div class="right-column">
                    @if ($pageNum === 1)
                        ...
                        <!-- Experience - Page 1: First 3 -->
                        @if(!empty($data['experience']) && count($data['experience']) > 0)
                        <div class="section-title">WORK EXPERIENCE</div>
                        @foreach(array_slice($data['experience'], 0, $firstPageExperiences) as $job)
                        ...
                        @endif
                    @else
                        <!-- Experience - Page 2+: Remaining experiences -->
                        @php
                            $startIdx = $firstPageExperiences + (($pageNum - 2) * $experiencesPerPage);
                            $pageExperiences = array_slice($data['experience'] ?? [], $startIdx, $experiencesPerPage);
                        @endphp
                        @if(count($pageExperiences) > 0)
                        <div class="section-title">WORK EXPERIENCE (CONTINUED)</div>
                        @foreach($pageExperiences as $job)
                        <div class="experience-item">
                            <div class="experience-title">{{ $job['title'] ?? '' }}</div>
                            <div class="experience-company">{{ $job['company'] ?? '' }}</div>
                            <div class="experience-date">

...
<template>
  <div>
        ...
        <div class="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-center lg:text-left">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-fade-in-up" style="animation-delay: 0.3s;">
                    <router-link to="/builder" class="w-full sm:w-auto px-8 py-4 rounded-xl bg-indigo-600 text-white font-bold shadow-lg hover:bg-indigo-500 hover:shadow-indigo-500/30 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2">
                        <i class="fa-solid fa-wand-magic-sparkles"></i> Build Resume
                    </router-link>
                    <router-link to="/ats-checker" class="w-full sm:w-auto px-8 py-4 rounded-xl bg-white text-slate-700 border border-slate-200 font-bold hover:bg-slate-50 transition-all flex items-center justify-center gap-2 hover:border-indigo-300">
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                ...
                <div class="lg:w-1/2 reveal">
                    ...
                    <router-link to="/ats-checker" class="group text-indigo-600 font-bold hover:text-indigo-700 border-b-2 border-indigo-200 hover:border-indigo-600 transition-all inline-flex items-center gap-2">
                ...
                <div class="group relative bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden reveal">
                    <div class="aspect-[3/4] bg-slate-200 relative">
                        ...
                        <div class="absolute inset-0 bg-slate-900/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                            <router-link to="/builder" class="px-6 py-3 bg-white text-slate-900 rounded-lg font-bold transform translate-y-4 group-hover:translate-y-0 transition-transform">Use Template</router-link>
                        </div>
                    </div>
    ...
    <section class="py-24 bg-white border-y border-slate-100">
        <div class="container mx-auto px-6">
             <div class="text-center mb-12 reveal">
                <h2 class="text-3xl font-display font-bold text-slate-900 mb-2">Live Editing Experience</h2>
                <p class="text-slate-600">Real-time preview as you type. No more guessing.</p>
            </div>

            <!-- Fake Editor UI -->
            <div class="max-w-5xl mx-auto rounded-xl border border-slate-200 shadow-2xl overflow-hidden bg-slate-900 reveal hover:shadow-indigo-500/20 transition-shadow duration-500">
                ...
                <div class="flex h-[400px] md:h-[500px]">
                    <!-- Left Panel (Inputs) -->
                    <div class="w-1/3 bg-white border-r border-slate-200 p-6 space-y-4 hidden md:block">
                        <div class="space-y-1">
                            <div class="h-2 w-12 bg-slate-200 rounded"></div>
                            <div class="h-8 w-full bg-slate-100 rounded border border-slate-200 animate-pulse"></div>
                        </div>
                        <div class="space-y-1">
                            <div class="h-2 w-12 bg-slate-200 rounded"></div>
                            <div class="h-24 w-full bg-slate-100 rounded border border-slate-200 p-2">
                                <div class="h-2 w-3/4 bg-slate-300 rounded mb-2"></div>
                                <div class="h-2 w-1/2 bg-slate-300 rounded"></div>
                            </div>
                        </div>
                        <div class="pt-4">
                            <div class="h-10 w-full bg-indigo-600 rounded-lg opacity-90"></div>
                        </div>
                    </div>
                    <!-- Right Panel (Preview) -->
                    <div class="flex-1 bg-slate-100 p-8 flex items-center justify-center">
                        <div class="w-full max-w-sm h-full bg-white shadow-lg p-6 space-y-3 transform hover:scale-[1.02] transition-transform duration-300">
                            <div class="h-6 w-1/2 bg-slate-800"></div>
                            <div class="h-3 w-full bg-slate-200"></div>
                            <div class="h-3 w-full bg-slate-200"></div>
                            <div class="mt-8 space-y-2">
                                <div class="h-4 w-1/3 bg-slate-400"></div>
    ...
    <section class="py-24 bg-slate-50">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-display font-bold text-center text-slate-900 mb-16 reveal">Loved by job seekers</h2>
            <div class="grid md:grid-cols-3 gap-6">
                <!-- Card 1 -->
                <div class="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm reveal hover-card">
                    <div class="flex text-yellow-400 mb-4 text-sm">
                        <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
                    </div>
                    <p class="text-slate-600 mb-6">"I applied to 50 jobs with my old resume and heard nothing. After using ResumeAI, I got 3 interviews in a week!"</p>
                    <div class="font-bold text-sm text-slate-900 flex items-center gap-2">
                        <div class="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-xs">SJ</div>
                        Sarah Jenkins
                    </div>
                </div>
                 <!-- Card 2 -->
                 <div class="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm reveal delay-100 hover-card">
                    <div class="flex text-yellow-400 mb-4 text-sm">
                        <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
                    </div>
                    <p class="text-slate-600 mb-6">"The ATS checker is a lifesaver. I didn't realize my resume format was unreadable by bots until now."</p>
                    <div class="font-bold text-sm text-slate-900 flex items-center gap-2">
                         <div class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-xs">MD</div>
                         Mark Davis
                    </div>
                </div>
                 <!-- Card 3 -->
                 <div class="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm reveal delay-200 hover-card">
                    <div class="flex text-yellow-400 mb-4 text-sm">
                        <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
                    </div>
                    <p class="text-slate-600 mb-6">"Simple, fast, and the templates look amazing. Worth every penny for the Pro plan."</p>
                    <div class="font-bold text-sm text-slate-900 flex items-center gap-2">
                         <div class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 font-bold text-xs">EL</div>
                         Emma Lee
                    </div>
                </div>
            </div>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6 max-w-4xl text-center">
            <h2 class="text-3xl font-display font-bold text-slate-900 mb-12 reveal">Plans for every career stage</h2>
            
            <div class="grid md:grid-cols-3 gap-6 items-center">
                <div class="p-6 border border-slate-200 rounded-xl text-slate-500 reveal hover:border-indigo-200 transition-colors">
                    <h3 class="font-bold text-lg mb-2">Free</h3>
                    <p class="text-3xl font-bold text-slate-900 mb-4">₹0</p>
                ...
                <div class="p-8 bg-slate-900 text-white rounded-2xl shadow-xl transform scale-105 relative reveal delay-100 hover:scale-110 transition-transform duration-300">
                    <div class="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-indigo-500 text-xs font-bold px-3 py-1 rounded-full animate-bounce">POPULAR</div>
                    <h3 class="font-bold text-xl mb-2">Pro</h3>
                    <p class="text-4xl font-bold mb-4">₹499</p>
                    <p class="text-indigo-200 text-sm mb-6">/month</p>
                    <ul class="text-sm space-y-3 mb-8 text-slate-300">
                        <li>Unlimited Resumes</li>
                        <li>AI Optimization</li>
                        <li>PDF Downloads</li>
                    </ul>
                    <router-link to="/pricing" class="block w-full py-3 bg-indigo-600 rounded-xl font-bold hover:bg-indigo-500 transition-colors shadow-lg hover:shadow-indigo-500/50">View Plans</router-link>
                </div>

                <div class="p-6 border border-slate-200 rounded-xl text-slate-500 reveal delay-200 hover:border-indigo-200 transition-colors">
                    <h3 class="font-bold text-lg mb-2">Premium</h3>
                    <p class="text-3xl font-bold text-slate-900 mb-4">₹999</p>
                    <ul class="text-sm space-y-2 mb-6">
                        <li>Cover Letters</li>
    ...
    <section class="py-24 bg-gradient-to-br from-indigo-900 to-slate-900 text-white text-center px-6 relative overflow-hidden">
        ...
        <div class="reveal relative z-10">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <router-link to="/builder" class="px-8 py-4 bg-white text-indigo-900 font-bold rounded-xl shadow-lg hover:bg-indigo-50 transition-colors transform hover:-translate-y-1">
                    Build Resume Free
                </router-link>
                <router-link to="/ats-checker" class="px-8 py-4 bg-transparent border border-indigo-400 text-white font-bold rounded-xl hover:bg-indigo-900/50 transition-colors transform hover:-translate-y-1">
                    Check ATS Score
                </router-link>
            </div>
        </div>

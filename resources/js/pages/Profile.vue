        ...
        <header class="glass-header sticky top-0 z-50">
            <div class="container mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center gap-8">
                    <router-link to="/builder" class="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors">Dashboard</router-link>
                    <router-link to="/builder" class="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors">Builder</router-link>
                    <router-link to="/ats-checker" class="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors">ATS Check</router-link>
                    <router-link to="/templates" class="text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors">Templates</router-link>
                    <router-link to="/profile" class="text-sm font-medium text-indigo-600 bg-indigo-50 px-3 py-1 rounded-md">Profile</router-link>
                </nav>
